...
public class UserController {
	...
	@PutMapping("/users/{id}")
	public ResponseEntity<Object> updateUser(@PathVariable("id") Long id, @RequestBody User updateUser) throws UserNotFoundException {
	...
	public ResponseEntity<Void> deleteUser(@PathVariable("id") long id) {
		...
		// DELETE endpoint to delete an order for a specific user
