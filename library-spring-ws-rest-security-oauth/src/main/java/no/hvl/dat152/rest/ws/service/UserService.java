...
public class UserService {
    ...
    public Order getUserOrder(Long userId, Long orderId) throws UserNotFoundException, OrderNotFoundException, AccessDeniedException {
    ...
    public void deleteUserOrder(Long userid, Long orderId) throws UserNotFoundException, OrderNotFoundException {
    ...
    public void verifyUser(Long userId) throws AccessDeniedException, UserNotFoundException {
